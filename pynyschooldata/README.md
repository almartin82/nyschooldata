...
Python wrapper for New York school enrollment data.

This is a thin rpy2 wrapper around the [nyschooldata](https://github.com/almartin82/nyschooldata) R package. It provides the same functionality but returns pandas DataFrames.

## Requirements

- Python 3.9+
- R 4.0+
- The `nyschooldata` R package installed
...
# Fetch one year
df = ny.fetch_enr(2025)

# Fetch multiple years
df_multi = ny.fetch_enr_multi([2020, 2021, 2022, 2023, 2024, 2025])
