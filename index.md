...
This package provides direct, automated access to enrollment data from
[NYSED](https://data.nysed.gov/), making it easy to explore **47 years
of data** (1977-2024) across 4,700+ schools and 700+ districts.

**Part of the [State Schooldata
Project](https://github.com/almartin82/njschooldata)** - a family of
R/Python packages providing consistent access to state-published school
data. Started with
[njschooldata](https://github.com/almartin82/njschooldata), now covering
all 50 states.
...
These stories come from the [full analysis
vignette](https://almartin82.github.io/nyschooldata/articles/district-hooks.html).
...
All data comes directly from [NYSED Information Reporting
...
Enrollment counts are collected on **BEDS Day** (Basic Educational Data
System Day), which falls in early October each year. This is the
official enrollment census date for New York State public schools.
...
Small cell sizes may be suppressed to protect student privacy and shown
as NA in the data.
...
- [Data Quality
  QA](https://almartin82.github.io/nyschooldata/articles/data-quality-qa.html)
