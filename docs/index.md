...
Since 2012, New York public schools have lost **295,521 students** -
equivalent to emptying every school in Buffalo, Rochester, Syracuse, and
Yonkers. But this headline masks a complex story: Pre-K exploded,
special education expanded, and only one county in the state actually
grew.
...
**The Shock**: 2024 showed the first positive year (+388 students) after
a decade of decline.

Explore the data: **[Full Analysis with
...
NYC DOE is the largest school district in the country. The package
automatically identifies NYC schools:
