...
## ----state-trend-plot, fig.cap="NY State Total Public School Enrollment"------
...
## ----yoy-plot, fig.cap="Year-over-year percentage change in enrollment"-------
ggplot(
...
## ----district-plot, fig.height=7, fig.cap="Major district enrollment trends"----
